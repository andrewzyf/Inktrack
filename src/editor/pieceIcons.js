...
const ICONS = {
  ...
  forkRight: `<path d="M6 38 V4 H16 V20 Q24 22 26 10 V4 H36 V16 Q34 30 18 34 V38 Z" ${ROAD}/><path d="M11 36 V6 M11 34 Q28 32 31 6" ${LINE}/>`,
  fork: `<path d="M34 38 V4 H24 V20 Q16 22 14 10 V4 H4 V16 Q6 30 22 34 V38 Z" ${ROAD}/><path d="M29 36 V6 M29 34 Q12 32 9 6" ${LINE}/>`,
